...
<div class="row">
    ...
    <div class="col-md-6">
        ...
        <h3>New Subject/Paper</h3>
        <hr>
        <form class="form-horizontal" action="/subject/subjectSave" method="POST">
			...
			<div class="form-group">
			    ...
			    <div class="col-sm-10">
			      	<input type="text" class="form-control" name="subject" id="subject" placeholder="Enter Subject" title="Subject Name required" >
			    </div>
			</div>
			...
			<div class="form-group">
			    ...
			    <div class="col-sm-10">
			      	<input type="date" class="form-control" name="syllabus_start_date" id="syllabus_start_date" >
			    </div>
			</div>
			...
			<div class="form-group">
			    ...
			    <div class="col-sm-10">
			      	<input type="text" class="form-control" name="code" id="code" placeholder="Enter subject code" >
			    </div>
			</div>
			...
			<div class="form-group">
			    ...
			    <div class="col-sm-10">
			      	<input type="text" class="form-control" name="fullmark" id="fullmark" placeholder="Enter subject fullmark" required title="Fullmark Required">
			    </div>
			</div>
			...
			<div class="form-group">
			    ...
			    <div class="col-sm-10">
			      	<input type="text" class="form-control" name="passmark" id="passmark" placeholder="Enter subject Passmark" required title="Passmark Required">
			    </div>
			</div>

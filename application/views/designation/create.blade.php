...
<div class="row">
    ...
    <div class="col-md-6">
        ...
        <hr>
        <form class="form-horizontal" action="/designation/designationSave" method="POST">
			<div class="form-group">
			    <label for="designation" class="col-sm-2 control-label">Designation</label>
			    <div class="col-sm-10">
			      	<input type="text" class="form-control" id="designation" name="designation" placeholder="Enter Designation" required title="Designation Required">
			    </div>
			</div>
